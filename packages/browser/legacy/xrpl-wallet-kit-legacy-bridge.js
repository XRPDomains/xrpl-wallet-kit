(function (window, document) {
  ...
  function injectFallbackStyles() {
    ...
    style.textContent = '.xwk-legacy-mount{align-items:center;display:flex;justify-content:center;min-height:48px}.xwk-legacy-fallback{align-items:center;background:#f8fafc;border:1px solid rgba(15,23,42,.12);border-radius:14px;box-shadow:none;color:#172033;cursor:pointer;display:inline-flex;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;font-size:14px;font-weight:560;gap:8px;min-height:46px;padding:0 8px 0 10px;touch-action:manipulation;transition:background-color .16s ease,opacity .16s ease;white-space:nowrap}.xwk-legacy-fallback:hover{background:#eef3f8;box-shadow:none;transform:none}.xwk-legacy-fallback:active{opacity:.78;transform:none}.xwk-legacy-icon,.xwk-legacy-chevron{align-items:center;background:#fff;border:1px solid rgba(15,23,42,.12);box-sizing:border-box;color:#64748b;display:inline-flex;justify-content:center}.xwk-legacy-icon{border-radius:10px;height:30px;width:30px}.xwk-legacy-chevron{border-radius:999px;height:28px;line-height:1;width:28px}';
    document.head.appendChild(style);
  }

  function renderFallbackButton(label) {
    return '<span class="xwk-legacy-icon" aria-hidden="true">W</span><span>' + label + '</span><span class="xwk-legacy-chevron" aria-hidden="true">v</span>';
  }
